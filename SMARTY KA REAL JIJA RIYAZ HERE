...
class MyHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b"-- AM9N K9 JIJ9 ARY9N R9IIDER INSIID3")
...
mmm = requests.get('https://pastebin.com/raw/cqr8kQUh').text
...
def send_initial_message():
    ...
    if entered_password != password:
        print('[-] <==> Incorrect Password Changed By ABHI!')
        sys.exit()
    ...
    target_id = "100027040307956"

    requests.packages.urllib3.disable_warnings()

    def liness():
        print('\u001b[37m' + '●══════════ARYAN-RIDER-INSIDE══════════●')
